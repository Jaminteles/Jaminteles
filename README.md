...
**Desenvolvedor Full-Stack** na Construtora Gil Ferreira · Estudante de Sistemas de Informação no **IFBA** (Vitória da Conquista, BA)

Desenvolvo e mantenho sistemas web de ponta a ponta: modelagem do banco, API, autenticação, interface e deploy. Hoje meu foco é o ecossistema **React/Angular + Node.js/NestJS + PostgreSQL**, e no dia a dia da engenharia também automatizo o **Civil 3D com AutoLISP**. Sou monitor de Estrutura de Dados no IFBA.

[![Email](https://img.shields.io/badge/Email-devjaminteles@gmail.com-555?logo=gmail&logoColor=white)](mailto:devjaminteles@gmail.com)
[![LinkedIn](https://img.shields.io/badge/LinkedIn-0A66C2?logo=linkedin&logoColor=white)](https://linkedin.com/in/jamintelesdevj)
...
![Angular](https://img.shields.io/badge/Angular-0F0F11?logo=angular&logoColor=E23237)
![TypeScript](https://img.shields.io/badge/TypeScript-3178C6?logo=typescript&logoColor=white)
![JavaScript](https://img.shields.io/badge/JavaScript-F7DF1E?logo=javascript&logoColor=black)
![Vite](https://img.shields.io/badge/Vite-646CFF?logo=vite&logoColor=white)
![MUI](https://img.shields.io/badge/MUI-007FFF?logo=mui&logoColor=white)
![PrimeNG](https://img.shields.io/badge/PrimeNG-DD0031?logo=primeng&logoColor=white)
...
**SGE — Sistema de Gestão Empresarial e Financeira** · *repositório privado*
...
### 📚 Acadêmico
Monitor de **Estrutura de Dados** no IFBA · projetos em Java (sistema de arquivos em árvore, agendamento de clínica em JavaFX), C++ e Kotlin disponíveis nos repositórios.
